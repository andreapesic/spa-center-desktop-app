...
namespace ApplicationLogic
{
    public class Controller
    {
        ...
        public List<RacunarskaKomponenta> ZapamtiRacunarskeKomponente(List<RacunarskaKomponenta> komponente)
        {
            ZapamtiRacunarskeKomponenteSO so = new ZapamtiRacunarskeKomponenteSO
            {
                RacunarskeKomponente = komponente
            };
            so.ExecuteTemplate(new RacunarskaKomponenta());
            return so.Result;
        }

        public List<RacunarskaKomponenta> VratiListuRacunarskihKomponenti()
        {
            VratiListuRacunarskihKomponenti so = new VratiListuRacunarskihKomponenti();
            so.ExecuteTemplate(new RacunarskaKomponenta());
            return so.Result;
        }
