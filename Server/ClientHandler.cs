            ...
            try
            {
                switch (request.Operation)
                {
                    ...
                    case Operation.ZapamtiUslugu:
                        ...
                        break;
                    case Operation.ZapamtiRacunarskeKomponente:
                        response.Result = Controller.Instance.ZapamtiRacunarskeKomponente((List<RacunarskaKomponenta>)request.RequestObject);
                        break;
                    case Operation.VratiRacunarskeKomponente:
                        response.Result = Controller.Instance.VratiListuRacunarskihKomponenti();
                        break;
