...
namespace Client.FormControllers
{
    public class FrmMainController
    {
        ...
        internal void OpenUCDodajRacunarskeKomponente(FrmMain frmMain)
        {
            frmMain.SetPanel(new UCDodajRacunarskeKomponente(new UCDodajRacunarskeKomponenteController()));
        }
    }
}
